...
echo "Using 'WabtecRE2020' for every password"


echo "Generating a root CA ..."

openssl genrsa -passout pass:WabtecRE2020 -out rootCA.key 2048
openssl req -passout pass:WabtecRE2020 -new -key rootCA.key -out rootCA.csr -subj "/C=US/ST=Maryland/L=Germantown/O=Wabtec/OU=Core Electronics/CN=WRE_CA_SelfSigned"
...
openssl genrsa -passout pass:WabtecRE2020 -out client.key 2048
openssl req -passout pass:WabtecRE2020 -new -key client.key -out client.csr -subj "/C=US/ST=Maryland/L=Germantown/O=Wabtec/OU=Core Electronics/CN=WRE_CA_SelfSigned"
...
openssl pkcs12 -passout pass:WabtecRE2020 -export -inkey client.key -in client.pem -name WRE_VRA_CLIENT -out client.pfx


echo "Generating first server certificate ..."

openssl genrsa -passout pass:WabtecRE2020 -out server.key 2048
openssl req -passout pass:WabtecRE2020 -new -key server.key -out server.csr -subj "/C=US/ST=Maryland/L=Germantown/O=Wabtec/OU=Core Electronics/CN=WRE_CA_SelfSigned"
...
openssl pkcs12 -passout pass:WabtecRE2020 -export -inkey server.key -in server.pem -name WRE_VRA_SERVER -out server.pfx
...
openssl genrsa -passout pass:WabtecRE2020 -out server_bkup.key 2048
openssl req -passout pass:WabtecRE2020 -new -key server_bkup.key -out server_bkup.csr -subj "/C=US/ST=Maryland/L=Germantown/O=Wabtec/OU=Core Electronics/CN=WRE_CA_SelfSigned"
...
openssl pkcs12 -passout pass:WabtecRE2020 -export -inkey server_bkup.key -in server_bkup.pem -name WRE_VRA_SERVER -out server_bkup.pfx
